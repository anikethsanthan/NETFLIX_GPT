  ...
  return (
    <div>
     <form className='p-6 pt-[10%] grid grid-cols-12'>
        ...
        <button className="p-4 m-4 col-span-3 ml-2 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white text-white rounded-lg " > {lang[langKey].search}</button>
        <select onChange={handleLanguageCHange}
          className='p-1 m-2 mt-10  col-span-1 bg-gray-900 text-white h-8 rounded-lg' >
